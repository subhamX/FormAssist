...
class _ExportScreenState extends State<ExportScreen> {
  String formId, uid, formName, formTypeName = 'NO_NAME';

  Future<void> _sendDetails() async {
    http.post(
      Config.serverBaseUrl + 'sendemailtoagent/',
  ...
  Future<void> _exportForm(int method) async {
    if (method == 3) {
      ...
      if (json["error"] == false) {
        Navigator.of(context).pop();
        FlutterClipboard.copy(Common.appUrl + json["url"]).then((result) => {
              Flushbar(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: RaisedButton(
                        ...
                        child: Text('EXPORT AS EXCEL DOCUMENT',
